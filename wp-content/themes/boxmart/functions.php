  ...
  function wp_bootstrap_theme_support() {
    ...
    register_nav_menus(                      // wp3+ menus
      array(
        ...
        'secondary_nav' => 'The Secondary Top Menu',
...
function wp_bootstrap_main_nav() {
  ...
  wp_nav_menu(
    array(
      ...
      'menu_class' => 'nav navbar-nav navbar-nav-main',
...
function wp_bootstrap_secondary_nav() {
  // Display the WordPress menu if available
  wp_nav_menu(
    array(
      ...
      'container' => 'false', /* container class */
      'fallback_cb' => 'wp_bootstrap_secondary_nav_fallback'
    )
  );
}
...
function wp_bootstrap_secondary_nav_fallback() {
  /* you can put a default here if you like */
}
